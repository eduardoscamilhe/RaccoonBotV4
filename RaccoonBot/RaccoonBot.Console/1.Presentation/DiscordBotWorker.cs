...
//namespace RaccoonBot.Infraestructure
//{
//    public class DiscordBotWorker : ServiceControl
//    {
...
//                {
//                    var role = guild.Roles.FirstOrDefault(x => x.Name.ToUpper() == activity.Name.ToUpper());
